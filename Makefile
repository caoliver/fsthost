...
CEXTRA             += -O2 -Wall -fPIC -Wno-deprecated-declarations -Wno-multichar -mfpmath=sse -msse2
...
# Shared LDFlags
LDFLAGS            := -mwindows
LIBRARIES          := -lpthread -lX11 $(shell pkg-config --libs $(PKG_CONFIG_MODULES)) -L/usr/local/wine/jack/lib

# Shared include / install paths
INCLUDE_PATH        = -I. -I/usr/include -I$(WINEDIR)/include/wine -I$(WINEDIR)/include/wine/windows -I/usr/local/wine/jack/include
DESTDIR             =
PREFIX              = /usr
