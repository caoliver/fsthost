...
CEXTRA                += -fno-pic -fno-PIC -m32 -g -Wall -Wno-missing-braces -Wno-multichar
CEXTRA                += -O2 -frounding-math -fsignaling-nans -mfpmath=sse -msse2
...
fsthost_C_SRCS        = audiomaster.c fst.c gtk.c jackvst.c jfst.c fxb.c fps.c vstwin.c cpuusage.c info.c midifilter.c
ifeq ($(LASH_EXISTS),yes)
